...
namespace Loginas.Repos
{
    public class GoogleAuthenticator
    {
        ...
        //    }
        //}
        public string GenerateProvisioningUrl(string identifier, byte[] key, int width, int height)
        {
            var KeyString = Encoder.Base32Encode(key);
            var ProvisionUrl = Encoder.UrlEncode(string.Format("otpauth://totp/{0}?secret={1}&issuer=3_Uzduotis", identifier, KeyString));
